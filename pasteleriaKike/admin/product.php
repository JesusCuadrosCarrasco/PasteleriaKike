    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="producto.php" class="active"><i class="fas fa-shopping-basket"></i>
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="agregarProducto.php"><button style ="width:150px; cursor:pointer">Registrar</button></a>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="productActualizar.php?id=<?php echo $row['codproducto'] ?>" class="btn btn-info">Editar</a></td>
